...
\section{Validation of Hybrid Forecasting Models Through the M4 Competition}

The M4 Competition article was selected because it provides large-scale validation of a hybrid forecasting model across a broad panel of time series. While the first source focuses on a single industrial context, the second offers a true testing ground across 100{,}000 series, thereby confirming localized findings on a global scale.
